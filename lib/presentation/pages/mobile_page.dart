      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            MobileFeatureDetermination(mobileFeature: displayText, features: displayFeaturesTexts, description: _helper.objectToList(_mobileModel.display), brandColor: _brandColor),
            MobileFeatureDetermination(mobileFeature: dimensionsAndWeightText, features: dimensionsAndWeightFeaturesTexts, description: _helper.objectToList(_mobileModel.dimensionsAndWeight), brandColor: _brandColor),
            MobileFeatureDetermination(mobileFeature: networkTechnologyText, features: dimensionsAndWeightFeaturesTexts, description: _helper.objectToList(_mobileModel.dimensionsAndWeight), brandColor: _brandColor),
            ...
            MobileFeatureDetermination(mobileFeature: chargingInlet, description: _helper.objectToList(_mobileModel.chargingInlet), brandColor: _brandColor),
